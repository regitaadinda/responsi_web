...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" mimeType="" description="" url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" size="" type="Local Area Network" name="File Geodatabase Feature Class"/>
  </links>
  <dates/>
  <fees></fees>
  ...
  <extent>
    <spatial maxz="0" minx="0" dimensions="2" miny="0" maxy="0" minz="0" crs="EPSG:4326" maxx="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
